...
public function insertarPaciente(empleado $paciente, persona $persona)
    {
        try {
            ...
            $statement->bindValue(0, $persona->__GET('Citas Programadas'));
            $statement->bindValue(5,  $persona->__GET('fecha asignada'));
            $statement->bindValue(1,  $persona->__GET('Area Programadas'));
